public class BaseCommisionEmployee extends CommisionEmployee{
   ...
   public String toString()
   {
      ...
      return String.format("BaseCommision Employee details :%nfirstname :%s%nlastname :%s%nssno :%s%ngrosssales :%.2f%ncommisionrate :%.2f%nbasesalary :%.2f%n",getFirstname(),getLastname(),getSsno(),getGrosssales(),getCommisionrate(),basesalary);
   }
}
